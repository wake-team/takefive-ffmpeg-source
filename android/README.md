...
##### 2.1.1 Android Tools
   ...
   - Android NDK r22b or later with LLDB and CMake (See [#292](https://github.com/wake-team/takefive-ffmpeg-source/issues/292) if you want to use NDK r23b or later)
...
1. Declare `mavenCentral` repository and add `FFmpegKit` dependency to your `build.gradle` in 
   ...
   project [README](https://github.com/wake-team/takefive-ffmpeg-source).
