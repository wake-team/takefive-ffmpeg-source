...
public class FFmpegKitFlutterPlugin implements FlutterPlugin, ActivityAware, MethodCallHandler, EventChannel.StreamHandler, PluginRegistry.ActivityResultListener {
    ...
    protected static Map<String, Object> toMap(final com.takefive.ffmpegkit.Log log) {
    ...
    protected static List<Map<String, Object>> toLogMapList(final List<com.takefive.ffmpegkit.Log> logList) {
        final List<Map<String, Object>> list = new ArrayList<>();
    ...
    protected static List<Map<String, Object>> toStatisticsMapList(final List<com.takefive.ffmpegkit.Statistics> statisticsList) {
        final List<Map<String, Object>> list = new ArrayList<>();
    ...
    protected void emitLog(final com.takefive.ffmpegkit.Log log) {
        final HashMap<String, Object> logMap = new HashMap<>();
