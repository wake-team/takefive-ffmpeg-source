...
<img src="https://github.com/wake-team/takefive-ffmpeg-source/raw/main/docs/assets/ffmpeg-kit-icon-v9.png" width="180">
...
See [Android](https://github.com/wake-team/takefive-ffmpeg-source/tree/development/android) to learn more about `FFmpegKit` for
`Android`.

### 3. iOS, macOS, tvOS

See [Apple](https://github.com/wake-team/takefive-ffmpeg-source/tree/development/apple) to use `FFmpegKit` on `Apple` platforms
(`iOS`, `macOS`, `tvOS`).

### 4. Flutter

See [Flutter](https://github.com/wake-team/takefive-ffmpeg-source/tree/main/flutter/flutter) to learn more about `FFmpegKit` for
`Flutter`.

### 5. Linux

See [Linux](https://github.com/wake-team/takefive-ffmpeg-source/tree/main/linux) to learn more about `FFmpegKit` for
`Linux`.

### 6. React Native

See [React Native](https://github.com/wake-team/takefive-ffmpeg-source/tree/main/react-native) to learn more about `FFmpegKit` for
`React Native`.
...
See our [CONTRIBUTING](https://github.com/wake-team/takefive-ffmpeg-source/blob/main/CONTRIBUTING.md) guide.
