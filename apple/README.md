...
1. Add `FFmpegKit` dependency to your `Podfile` in `ffmpeg-kit-<platform>-<package name>` pattern. Use one of the 
   `FFmpegKit` package names given in the project [README](https://github.com/wake-team/takefive-ffmpeg-source).
...
developed under the [FFmpegKit Test](https://github.com/wake-team/takefive-ffmpeg-source-test) project.
